...
odoo.define(
    "ssi_hr_cash_advance_documenso_signing.hr_cash_advance_settlement_tour",
    function (require) {
        "use strict";
        ...
        // it never calls the external Documenso service and never
        // triggers creation of a signature request (Keputusan Desain,
