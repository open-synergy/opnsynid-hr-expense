...
odoo.define("ssi_hr_cash_advance_documenso_signing.hr_cash_advance_tour", function (
    require
) {
    "use strict";
    ...
    // ssi_hr_cash_advance/docs/hr_cash_advance/05-approve.md Flow steps
    ...
    // base Flow steps 3-4 (Approve / OK) and the resulting Open status
    ...
    // Desain, issue open-synergy/opnsynid-hr-expense#108).
    tour.register(
