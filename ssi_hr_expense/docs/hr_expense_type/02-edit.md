...
5. On the header, click **Generate Code** to assign a new code automatically — for
   example after changing the **Code** field back to **/**. Only works while the
   **Code** field is **/**; skipping it leaves the current code unchanged.
6. Alternatively, from the **Types** list, select the record's checkbox and click
