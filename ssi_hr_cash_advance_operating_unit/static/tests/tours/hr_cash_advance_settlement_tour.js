...
odoo.define(
    "ssi_hr_cash_advance_operating_unit.hr_cash_advance_settlement_tour",
    function (require) {
        "use strict";
        ...
        tour.register(
            ...
            [
                ...
                // Advance Settlements menu. "Expense" is a grouping
                // header (menuitem without an action) that nests "Cash
                // Advance Settlements", so it has no step of its own
                ...
                },
                {
                    ...
                    // left over from the landing action (patterns.md §A).
                ...
                // Additional Fields (docs/hr_cash_advance_settlement/01-
                // create.md, delta of ssi_hr_cash_advance_operating_unit)
                // — the Operating Unit field added by
                // mixin.single_operating_unit is rendered on the create
                // form for a user in the multi operating unit group.
                // Delta-only tour: it stops here, it does not fill any
                // field and does not continue to Save (E1 delta-only;
