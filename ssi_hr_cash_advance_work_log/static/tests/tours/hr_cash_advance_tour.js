...
odoo.define("ssi_hr_cash_advance_work_log.hr_cash_advance_tour", function (require) {
    "use strict";
    ...
    tour.register(
        ...
        [
            ...
            // Additional Fields (docs/hr_cash_advance/01-create.md,
            // delta of ssi_hr_cash_advance_work_log) — the Work Log
            // tab added by mixin.work_object is rendered on the create
            // form. Delta-only tour: it stops here, it does not fill
            // any field and does not continue to Save
