...
- **Estimation**: The planned amount of work for this cash advance, entered in hours.
  Optional.
- **Work Log Analytic Account**: The analytic account used to track work logged against
  this cash advance. Optional.
- **Work Logs**: A list below **Work Log Analytic Account** where work performed against
  this cash advance is recorded. Click **Add a line** to open the Work Log entry dialog;
