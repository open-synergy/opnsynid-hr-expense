...
> **Module:** ssi_hr_cash_advance_work_log
>
...
- **Module:** `ssi_hr_cash_advance_work_log` is installed.

## Additional Fields

When this module is installed, the create form gains a **Work Log** tab:

- **Estimation**: The planned amount of work for this cash advance settlement, entered
  in hours. Optional.
- **Work Log Analytic Account**: The analytic account used to track work logged against
  this cash advance settlement. Optional.
- **Work Logs**: A list below **Work Log Analytic Account** where work performed against
  this cash advance settlement is recorded. Click **Add a line** to open the Work Log
  entry dialog; repeat as many times as needed.
