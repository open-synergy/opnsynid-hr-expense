[![Build Status](https://travis-ci.com/open-synergy/opnsynid-hr-expense.svg?branch=14.0)](https://travis-ci.com/open-synergy/opnsynid-hr-expense)
...
--- | --- | --- | ---
[ssi_employee_business_trip](ssi_employee_business_trip/) | 14.0.2.5.5 |  | Employee Business Trip
...
[ssi_hr_cash_advance](ssi_hr_cash_advance/) | 14.0.1.18.0 |  | Employee Cash Advance
[ssi_hr_cash_advance_documenso_signing](ssi_hr_cash_advance_documenso_signing/) | 14.0.1.1.0 |  | HR Cash Advance - Documenso Signing Integration
[ssi_hr_cash_advance_operating_unit](ssi_hr_cash_advance_operating_unit/) | 14.0.1.2.1 |  | Employee Cash Advance + Operating Unit
[ssi_hr_cash_advance_work_log](ssi_hr_cash_advance_work_log/) | 14.0.1.0.0 |  | Employee Cash Advance - Work Log Integration
[ssi_hr_expense](ssi_hr_expense/) | 14.0.1.5.1 |  | Employee Expense
[ssi_hr_expense_account](ssi_hr_expense_account/) | 14.0.1.5.4 |  | Employee Expense Account
[ssi_hr_expense_account_cash_advance](ssi_hr_expense_account_cash_advance/) | 14.0.1.3.5 |  | Employee Expense Account - Cash Advance Integration
...
[ssi_hr_expense_account_reimbursement](ssi_hr_expense_account_reimbursement/) | 14.0.1.4.3 |  | Employee Expense Account - Reimbursement Integration
[ssi_hr_expense_account_work_log](ssi_hr_expense_account_work_log/) | 14.0.1.1.0 |  | Employee Expense Account - Work Log Integration
[ssi_hr_reimbursement](ssi_hr_reimbursement/) | 14.0.3.3.0 |  | Employee Reimbursement
...
[ssi_hr_reimbursement_operating_unit](ssi_hr_reimbursement_operating_unit/) | 14.0.1.3.0 |  | Employee Reimbursement + Operating Unit
